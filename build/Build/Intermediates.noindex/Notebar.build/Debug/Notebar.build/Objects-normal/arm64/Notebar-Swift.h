...
#ifndef NOTEBAR_SWIFT_H
#define NOTEBAR_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="Notebar",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class NSApplication;
SWIFT_CLASS("_TtC7Notebar11AppDelegate")
...
/// <code>NSPanel</code> rather than <code>NSWindow</code>, and specifically <code>.nonactivatingPanel</code>:
/// that style mask is what lets the panel accept keystrokes <em>without</em>
...
SWIFT_CLASS("_TtC7Notebar9EdgePanel")
